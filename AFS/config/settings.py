"""
Django settings for Faculty Scheduling System project.
"""
...
def _database_config_from_url(database_url):
    ...
    if parsed.scheme in {'sqlite', 'sqlite3'}:
        ...
        if sqlite_path.startswith('/') and os.name == 'nt':
...
if database_url:
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': os.getenv('DATABASE_NAME', 'faculty_scheduling'),
...
# Security Settings (Development - update for production)
